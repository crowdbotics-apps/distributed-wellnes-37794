...
## Project Structure
    ...
    ├── distributed_wellnes_37794  # Django project configurations
...
1. Clone this repo and `cd distributed_wellnes_37794`
...
2. Clone this repo and `cd distributed_wellnes_37794`
